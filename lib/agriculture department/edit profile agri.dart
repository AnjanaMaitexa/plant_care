...
*/
  ...
  void fetchUserData() {
    ...
    userId = user!.uid;
    FirebaseFirestore.instance.collection('agriculture').doc(userId).get().then((DocumentSnapshot documentSnapshot) {
  ...
  void updateUserData(String fullname, String phn,String location) {
    FirebaseFirestore.instance.collection('agriculture').doc(userId).update({
      'name': fullname,
      'phone': phn,
      'location':location
    }).then((value) {
      Navigator.push(context, MaterialPageRoute(builder: (context)=>Homeagri()));
  ...
  Widget build(BuildContext context) {
    ...
    /*   Padding(
                 ...
                 /* SizedBox(height: 10,),
                  ...
                  SizedBox(height: 10,),
                  ElevatedButton(
                    onPressed: ()=> updateUserData(_namecontroller.text.trim(),_phonecontroller.text.trim(),locationcontroller.text.trim()), /*Navigator.push(
                        context, MaterialPageRoute(builder: (context) => Homeagri())),
